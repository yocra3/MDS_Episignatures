...
## Load phenotype data
pheno_data <- read_excel("/home/cruizarenas/MDS_Episignatures/data/GSE105420_CMML_SOFT_Annotated.xlsx")
molecular_data <- read_excel("/home/cruizarenas/MDS_Episignatures/data/GSE105420_CMML_SOFT_Annotated.xlsx", 
    sheet = 2)
