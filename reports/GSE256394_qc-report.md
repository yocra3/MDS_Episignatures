...
There are 182 samples analysed.
...
There are 1 sex detection outliers, and 3 sex detection mismatches.


|sample.name |predicted.sex |declared.sex |   xy.diff|status     |
|:-----------|:-------------|:------------|---------:|:----------|
|GSM8096886  |F             |M            | -3.268678|mismatched |
|GSM8097010  |F             |M            | -2.479421|mismatched |
|GSM8096981  |F             |M            | -2.426811|mismatched |
|GSM8096947  |M             |M            | -1.867854|outlier    |
...
There are 2 outliers from the meth vs unmeth comparison.
...
|:-----------|----------:|------------:|----------:|-------------:|--------:|--------:|:--------|
|GSM8096950  |   2299.420|     1637.934| -1373.8573|      3673.277| 4420.014|  2926.54|TRUE     |
|GSM8097016  |   2859.693|     1715.158|  -792.2637|      3651.957| 4398.694|  2905.22|TRUE     |
...
|:-----------|:-----------|---:|:--------------------|-----:|:--------|
|GSM8097046  |1           | 177|extension.R.63642461 | 63611|TRUE     |
...
##  [27] annotate_1.88.0           DelayedMatrixStats_1.32.0
##  [29] codetools_0.2-20          DelayedArray_0.36.0      
##  [31] xml2_1.5.1                tidyselect_1.2.1         
##  [33] farver_2.1.2              beanplot_1.3.1           
##  [35] GenomicAlignments_1.46.0  jsonlite_2.0.0           
##  [37] multtest_2.66.0           tools_4.5.2              
##  [39] Rcpp_1.1.1                glue_1.8.0               
##  [41] SparseArray_1.10.9        xfun_0.56                
##  [43] HDF5Array_1.38.0          withr_3.0.2              
##  [45] fastmap_1.2.0             boot_1.3-32              
##  [47] rhdf5filters_1.22.0       openssl_2.3.5            
##  [49] digest_0.6.39             timechange_0.4.0         
##  [51] R6_2.6.1                  RSQLite_2.4.6            
##  [53] R.methodsS3_1.8.2         cigarillo_1.0.0          
##  [55] h5mread_1.2.1             data.table_1.18.2.1      
##  [57] rtracklayer_1.70.1        httr_1.4.8               
##  [59] S4Arrays_1.10.1           pkgconfig_2.0.3          
##  [61] gtable_0.3.6              blob_1.3.0               
##  [63] S7_0.2.1                  siggenes_1.84.0          
##  [65] clue_0.3-67               scales_1.4.0             
##  [67] png_0.1-9                 reformulas_0.4.4         
##  [69] tzdb_0.5.0                rjson_0.2.23             
##  [71] curl_7.0.0                nloptr_2.2.1             
##  [73] cachem_1.1.0              rhdf5_2.54.1             
##  [75] AnnotationDbi_1.72.0      restfulr_0.0.16          
##  [77] pillar_1.11.1             grid_4.5.2               
##  [79] reshape_0.8.10            vctrs_0.7.1              
##  [81] cluster_2.1.8.1           xtable_1.8-8             
##  [83] evaluate_1.0.5            GenomicFeatures_1.62.0   
##  [85] cli_3.6.5                 compiler_4.5.2           
##  [87] Rsamtools_2.26.0          rlang_1.1.7              
##  [89] crayon_1.5.3              rngtools_1.5.2           
##  [91] labeling_0.4.3            nor1mix_1.3-3            
##  [93] mclust_6.1.2              stringi_1.8.7            
##  [95] hms_1.1.4                 sparseMatrixStats_1.22.0 
##  [97] bit64_4.6.0-1             Rhdf5lib_1.32.0          
##  [99] KEGGREST_1.50.0           rbibutils_2.4.1          
## [101] memoise_2.0.1             bit_4.6.0
```
